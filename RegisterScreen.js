...
const createStyles = (c) => StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: 'bold', marginBottom: 30, textAlign: 'center', color: c.primary },
  input: { borderWidth: 1, borderColor: c.border, padding: 15, borderRadius: 12, marginBottom: 15, fontSize: 16, backgroundColor: c.inputBackground, color: c.text },
  label: { fontSize: 16, marginBottom: 10, fontWeight: 'bold', color: c.text },
  roleContainer: { flexDirection: 'row', marginBottom: 25, gap: 10 },
  roleButton: { flex: 1, padding: 12, borderWidth: 2, borderColor: c.primary, borderRadius: 12, alignItems: 'center' },
  activeRole: { backgroundColor: c.primary },
  roleText: { color: c.primary, fontWeight: 'bold' },
  activeText: { color: '#fff', fontWeight: 'bold' },
  button: { backgroundColor: c.primary, padding: 18, borderRadius: 12, alignItems: 'center', marginTop: 10 },
  buttonDisabled: { opacity: 0.7 },
  buttonText: { color: '#fff', fontWeight: 'bold', fontSize: 18 },
  linkText: { textAlign: 'center', marginTop: 20, color: c.primary, fontSize: 16 },
});